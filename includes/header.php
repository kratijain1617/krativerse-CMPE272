    ...
    <header class="site-header">
        <nav class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="<?php echo $base; ?>lab-products-cookies/products.php" <?php echo ($currentPage ?? '') === 'products' ? 'class="active"' : ''; ?>>Products & Services</a></li>
                ...
                <li><a href="<?php echo $base; ?>users.php" <?php echo ($currentPage ?? '') === 'users' ? 'class="active"' : ''; ?>>Users</a></li>
